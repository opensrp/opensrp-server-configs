...
CREATE INDEX client_metadata_location_id_index ON core.client_metadata(location_id);
CREATE INDEX client_metadata_client_type_index ON core.client_metadata(client_type);
-- //@UNDO
-- SQL to undo the change goes here.

DROP INDEX core.client_metadata_location_id_index;
DROP INDEX core.client_metadata_client_type_index;
